...
// Code comes from: https://github.com/derpibooru/philomena/blob/master/assets/js/utils/local-autocompleter.js
...
export class LocalAutocompleter {
  ...
  topK(prefix, k) {
    ...
    const prefixMatch = (/** @type {string} */ name) =>
    ...
    const namespaceMatch = (/** @type {string} */ name) =>
